...
NW_CODES = {
    "NW0100": {
        ...
        "type": "doc",
        "tips": "⚠️ 需一式7份(山坡地8份)。起造人、承造人、監造人皆需用印。若為變更設計案，需確認是否已完成變更程序。"
    },
    "NW0300": {
        "name": "承造人施工計畫書簽章負責表", 
        "type": "doc",
        "tips": "⚠️ 確認表上人員(專任工程人員、工地主任)與營造業手冊登記一致。簽名欄位不可蓋章代替。"
    },
    "NW1000": {
        "name": "營建工程空氣污染防制費繳款收據", 
        "type": "doc",
        "tips": "⚠️ 這是「第一級」或「第二級」費率？請先上環保局網站試算。繳費後需掃描收據上傳，不可只傳申報單。"
    },
    "NW1100": {
        "name": "逕流廢水削減計畫核備函", 
        "type": "doc",
        "tips": "⚠️ 觸發門檻：基地面積 × 工期 > 4600。必須先向環保局取得「核備函」才能報開工，注意公文往返時間約需 14-21 天。"
    },
    "NW2300": {
        "name": "鄰房現況鑑定報告書 (公會備查函)", 
        "type": "doc",
        "tips": "⚠️ 拆除工程的「保命符」。必須在拆除前完成鑑定並取得公會備查函。若因鄰居拒絕鑑定，需檢附「存證信函」證明已盡力。"
    },
    "NW2400": {
        "name": "建築物拆除施工計畫書 (B14-5)", 
        "type": "doc",
        "tips": "⚠️ 需依內政部訂頒格式撰寫。若有地下室，需包含地下室回填或支撐計畫。"
    },
    "NW2500": {
        "name": "建築物監拆報告書 (B14-3)", 
        "type": "doc",
        "tips": "⚠️ 由建築師簽證。需檢附現場拆除前照片，證明尚未動工。"
    },
    "NW2600": {
        "name": "營建剩餘土石方處理計畫 (B5核准函)", 
        "type": "doc",
        "tips": "⚠️ 俗稱「棄土證明」。需確認土資場是否有剩餘收容容量。兩階段申報：先報計畫(取得核准函)，開挖前再報流向。"
    },
    "NW2700": {
        "name": "營建混合物(廢棄物)處理計畫 (B8核准函)", 
        "type": "doc",
        "tips": "⚠️ 俗稱「垃圾處理」。環保局管轄。若新建工程面積>500m²或造價>500萬即需辦理。"
    },
    "NW3300": {
        "name": "建築工程施工計畫書 (含防災/品管)", 
        "type": "doc",
        "tips": "⚠️ 核心文件。若基地開挖深度>12m或樓高>50m，需先完成「施工計畫外審」(需公會召開委員會審查)。"
    },
    "NW3500": {
        "name": "工地主任執業證 (含公會會員證)", 
        "type": "doc",
        "tips": "⚠️ 需檢附：1.執業證(有效期限內) 2.公會會員證 3.回訓證明。工地主任必須是「專任」，不能掛名其他案子。"
    },
    "NW5000": {
        "name": "結構配筋圖 (A3掃描檔)", 
        "type": "drawing",
        "tips": "⚠️ 必須掃描成 A3 格式 (300dpi 以上)。需包含柱、樑、版、牆配筋詳圖。電子檔名編碼務必正確。"
    },
    "NW5100": {
        "name": "安全圍籬綠美化及防溢座圖說", 
        "type": "drawing",
        "tips": "⚠️ 台北市規定：臨路寬度>10公尺，圍籬需50%以上綠美化。防溢座高度需符合規定(通常30-60cm)。"
    },
    "NS1300": {
        "name": "鋼筋無輻射證明書", 
        "type": "doc",
        "tips": "⚠️ 每一批進場鋼筋都要附。需確認爐號與出廠證明相符。"
    },
    "NS1900": {
        "name": "混凝土抗壓強度試驗報告", 
        "type": "doc",
        "tips": "⚠️ 時間差陷阱！28天強度報告出來後才能報下一層樓。記得提早送實驗室。"
    },
    "NS2200": {
        "name": "建築師公會抽查紀錄表", 
        "type": "doc",
        "tips": "⚠️ 2樓版(或其他指定樓層)勘驗前，需由公會派員抽查。缺失改善完畢才能申報勘驗。"
    },
    "NS2400": {
        "name": "紅火蟻清查紀錄表", 
        "type": "doc",
        "tips": "⚠️ 每月1-5號需重新填寫並上傳。若發現紅火蟻需通報並投藥。"
    },
}
...
GAME_GLOSSARY = {
    "數位憑證類": {
        ...
        "自然人憑證": "個人的數位身分證。通常用於起造人（業主）的身分驗證，但在建管申報中，主要操作者還是承造人（營造廠）與監造人（建築師）。",
        "HiCOS 元件": "政府機關專用的跨平台網頁元件。必須安裝這個驅動程式，瀏覽器才能讀取讀卡機中的憑證卡。常因瀏覽器版本更新而失效，是工程師的噩夢。",
    },
    "計畫與文件類": {
        "B5 (營建剩餘土石方)": "指施工挖出來的「乾淨土石」。因為是有價資源，不能隨便亂倒，必須運往合法的「土資場」或需土工地。開工前需先核定計畫，運送時需有流向證明。",
        "B8 (營建混合物)": "指施工產生的「垃圾」（如廢木材、塑膠、包裝紙）。這歸環保局管，必須委託合格的清運業者運往焚化爐或分類場。",
        "逕流廢水削減計畫": "為了防止工地泥水流到馬路或水溝汙染環境的計畫。依規定，基地面積x工期 > 4600 的工地必須提送。",
        "鄰房鑑定": "在開工（拆除）前，請公會技師去隔壁房子拍照、記錄現有裂縫。這是為了釐清責任，避免未來鄰居把舊裂縫賴給工地。",
    },
    "人員角色類": {
        "起造人": "出錢的老闆（業主/建設公司）。",
        "承造人": "負責蓋房子的營造廠。",
        "監造人": "負責監督工程品質的建築師。",
        "專任工程人員": "營造廠聘請的專業技師（土木/結構/建築），負責解決工程技術問題並簽證。",
        "工地主任": "工地現場的指揮官。需持有執業證，負責現場調度、勞安與進度管理。",
    },
    "工法與術語": {
        "順打工法": "最傳統的蓋法。先挖土挖到底，做好地基，再像堆積木一樣往上蓋。優點是技術單純，缺點是深開挖時擋土風險較高。",
        "逆打工法": "先做地下一樓頂版(1FL)，然後同時「往上蓋樓」跟「往下挖土」。優點是工期快，缺點是技術難度高、通風採光差、造價貴。",
        "放樣勘驗": "把圖紙上的柱子、牆壁位置，用墨線畫在基地地板上，請政府官員來看。確認房子沒有蓋歪或蓋出界，是蓋房子最重要的第一步。",
    }
}
...
def render_main_game():
    ...
    with st.sidebar:
        ...
        # --- 建築百科 Wiki (Sidebar) ---
        with st.expander("📖 建築百科 (名詞解釋)"):
            tab_names = list(GAME_GLOSSARY.keys())
            wiki_tabs = st.tabs(tab_names)
            for i, category in enumerate(tab_names):
                with wiki_tabs[i]:
                    for term, desc in GAME_GLOSSARY[category].items():
                        st.markdown(f"**{term}**")
                        st.caption(desc)
                        st.markdown("---")
        # ----------------------------
...
def render_paperless_minigame():
    st.title("💻 台北市無紙化上傳系統")
    st.info("任務：請選擇左側文件，並配對正確的 NW 編碼。注意右側的「小撇步」提示！")
    ...
    with c_ws:
        ...
        with st.container(border=True):
            ...
            if sel_code != "請選擇...":
                ...
                st.info(f"💡 **申辦小撇步**\n\n{item_data['tips']}")
                st.caption(f"正式名稱：{item_data['name']}")
    ...
    with c_list:
        st.markdown("📜 **文件編碼速查**")
        data = [{"代碼": k, "文件名稱": v["name"]} for k, v in NW_CODES.items()]
